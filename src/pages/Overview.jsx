        ...
        <div className='flex-1 flex flex-col lg:ml-64'>
            ...
            <main className='p-5 md:p-6  '>
              <div className='py-4  flex justify-between items-center'>
                <h1 className='font-worksans font-bold text-2xl text-[#247b7b]'>Overview</h1>
                ...
                <div className='flex items-center border border-gray-300 p-2.5 rounded-md focus:outline-none'>
                    ...
                    <p className='font-nunito font-medium '>Date Range</p>
                    <Tally1 size={18} className='inline ml-2 text-gray-400 '/>
                    <div className='px-2'>
                    <p className='font-nunito font-medium'>Nov 1, 2022 - Nov 7, 2022.</p>
                    </div>
